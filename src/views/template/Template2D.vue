<template>
  <div class="content">
    ...
    <el-drawer size="50%" title="3D模型" :visible.sync="drawer" direction="rtl">
      <el-form class="form" style="margin-top:-32px">
        <!-- <el-divider v-if="check==0" content-position="left">查询3D模型</el-divider>
        <el-divider v-if="check==1" content-position="left">新增3D模型</el-divider>
        <el-divider v-if="check==2" content-position="left">修改3D模型</el-divider> -->
          ...
          <el-col :span="11">
            <el-form label-width="110px" label-position="left">
              <el-form-item label="服装原图:">
                <img width="50%" class="imgDown" @click="getfile(temporaryDate.clotheImage)" :src="temporaryDate.clotheImage" />
              </el-form-item>
            </el-form>
          </el-col>
          <el-col :span="6">
          ...
          <el-col :span="11">
            <el-form label-width="110px" label-position="left">
              <el-form-item label="模型名:">
                  <el-input v-if="check!=0" type="text" v-model="temporaryDate.templateName" id ></el-input>
                  <input
                    v-if="check==0"
                    readonly
                    type="text"
          ...
          <el-col :span="11">
            <el-form label-width="110px" label-position="left">
              <el-form-item label="宽度:">
                  ...
                  />
                  <el-input v-if="check!=0" type="number" v-model="temporaryDate.width" @input="$forceUpdate()" ></el-input>
            ...
            <el-form label-width="110px" label-position="left">
              <el-form-item label="高度:">
                  <input
                    ...
                    id
                  />
                  <el-input v-if="check!=0" type="number" v-model="temporaryDate.height" @input="$forceUpdate()" ></el-input>
              </el-form-item>
            </el-form>
          </el-col>
        </el-row>
        ...
        <el-row>
          ...
          <el-col v-if="check==0" :span="5">
            <el-button type="primary" @click="drawercancel()" size="medium">确定</el-button>
          </el-col>
          <el-col :span="6">
      ...
      <div class="dataContent">
          ...
          <div class="searchForm">
            <el-form :inline="true" class="demo-form-inline">
              <el-form-item label="关键字:">
                <el-input v-model="searchParams.getTemplate2ds.key" placeholder="关键字"></el-input>
              </el-form-item>
              <el-form-item>
        ...
        <div class="dataListArea">
          <el-table class="tableData" :data="tableData" border stripe width="100%">
            <el-table-column align="center" label="背景图片缩略图" width="150">
...
export default {
  ...
  data() {
    return {
      //请求的接口
      actions: {
        getTemplate2ds: "/template2d/getTemplate2ds", //3d模特查询
        updateTemplate2d: "/template2d/updateTemplate2d", //3d模特修改
        addTemplate2d: "/template2d/addTemplate2d" //3d模特新增
      },
      //查询参数
      searchParams: {
        getTemplate2ds: {
  ...
  methods: {
    ...
    getData() {
      httpUtil.xhrPost(
        this,
        this.actions.getTemplate2ds,
        {
          ...this.searchParams.getTemplate2ds,
          ...this.page
        },
        data => {
    ...
    reset() {
      ...
      this.page.rows = 10;
      this.page.total = 0;
      this.searchParams.getTemplate2ds.key = "";
      this.getData();
      this.$forceUpdate();
    },
