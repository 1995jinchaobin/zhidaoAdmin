      ...
      <div class="dataContent">
        ...
        <div class="dataListArea">
          <el-table class="tableData" :data="tableData" border stripe width="100%">
            ...
            <el-table-column align="center" :show-overflow-tooltip="true" prop="name" label="素材名称" width="300">
            </el-table-column>
              ...
              <el-col :span="12">
                <el-form label-width="100px">
                  <el-form-item label="图片预览:">
                    <img width="50%" class="imgDown" @click="downLoad(detailInfo.picture)" :src="detailInfo.picture" />
                  </el-form-item>
                </el-form>
              </el-col>
            </el-row>
              ...
              <el-col :span="12">
                <el-form label-width="100px">
                  <el-form-item label="卖家用户编号:">
                    <label>{{detailInfo.sellerUserId}}</label>
                  </el-form-item>
                </el-form>
              </el-col>
            </el-row>
              ...
              <el-col :span="12">
                <el-form label-width="100px">
                  <el-form-item label="素材类型:">
                    <label>{{detailInfo.printingOrEmbroider==0?'印花':'绣花'}}</label>
                  </el-form-item>
                </el-form>
              </el-col>
            </el-row>
            ...
            <div style="margin-bottom: 30px;" v-if="user.roleBtns.indexOf(url+'update')>-1">
              ...
              <el-row>
                <el-col :span="3">
                  <el-form label-width="100px">
                    <el-form-item label="">
                      <el-button @click="checkMaterial()" type="primary" size="medium">确定</el-button>
                    </el-form-item>
                  </el-form>
                </el-col>
                <el-col :span="3">
  ...
  export default {
    ...
    methods: {
      ...
      check(row) {
        ...
        this.checkState.type=this.detailInfo.type;
      ...
      checkMaterial() {
        ...
        //请求
        httpUtil.xhrPost(this, this.actions.updateMaterial, {
          ...this.checkState
        }, (data) => {
