    ...
    <el-drawer size="50%" title="审核详情" :visible.sync="drawer" direction="rtl">
      <el-form class="form" style="margin-top:-32px">
        ...
        <el-row>
          ...
          <el-col :span="11">
            <el-form label-width="110px" label-position="left">
              <el-form-item label="工作室Logo:">
                <img width="50%" :src="temporaryDate.studioLogo" />
                <el-button
                  type="primary"
                  @click="getfile(temporaryDate.studioLogo)"
                  size="small"
                >点击下载</el-button>
              </el-form-item>
            </el-form>
          ...
          <el-col :span="11">
            <el-form label-width="110px" label-position="left">
              <el-form-item v-if="temporaryDate.corporateStudioYn==0" label="示例作品:">
                <el-button
                  type="primary"
                  @click="getfile(temporaryDate.theSampleWorks)"
                  size="small"
                >点击下载</el-button>
              </el-form-item>
              <el-form-item v-if="temporaryDate.corporateStudioYn==1" label="营业执照:">
                <img width="50%" :src="temporaryDate.businessLicense " />
                <el-button
                  type="primary"
                  @click="getfile(temporaryDate.businessLicense)"
                  size="small"
                >点击下载</el-button>
              </el-form-item>
            </el-form>
          ...
          <el-col :span="11">
            <el-form label-width="110px" label-position="left">
              <el-form-item label="工作室简介:">
                ...
                >
                  <label
                    v-if="temporaryDate.studioIntroduction !='null'&&temporaryDate.studioIntroduction !=null&&temporaryDate.studioIntroduction !=undefined&&temporaryDate.studioIntroduction .length>15"
          ...
          <el-col :span="11">
            <el-form label-width="110px" label-position="left">
              <el-form-item label="手持正面照:">
                <img width="50%" :src="temporaryDate.identityPersonCard " />
                <el-button
                  type="primary"
                  @click="getfile(temporaryDate.identityPersonCard)"
                  size="small"
                >点击下载</el-button>
              </el-form-item>
            </el-form>
          ...
          <el-col :span="11">
            <el-form label-width="110px" label-position="left">
              <el-form-item label="身份证正面:">
                <img width="50%" :src="temporaryDate.identityCardFront " />
                <el-button
                  type="primary"
                  @click="getfile(temporaryDate.identityCardFront)"
                  size="small"
                >点击下载</el-button>
              </el-form-item>
            </el-form>
          ...
          <el-col :span="11">
            <el-form label-width="110px" label-position="left">
              <el-form-item label="身份证背面:">
                <img width="50%" :src="temporaryDate.identityCardVerso " />
                <el-button
                  type="primary"
                  @click="getfile(temporaryDate.identityCardVerso)"
                  size="small"
                >点击下载</el-button>
              </el-form-item>
            </el-form>
          ...
          <el-col :span="11">
            <el-form label-width="110px" label-position="left">
              <el-form-item label="个人履历:">
                ...
                >
                  <label
                    v-if="temporaryDate.curriculumVitae !='null'&&temporaryDate.curriculumVitae !=null&&temporaryDate.curriculumVitae !=undefined&&temporaryDate.curriculumVitae .length>15"
        ...
        <div v-if="check&&user.roleBtns.indexOf(url+'check')>-1">
								...
								<el-col :span="23">
									<el-form label-width="100px">
										<el-form-item label="审核备注:">
											<el-input type="textarea" :rows="4" v-model="searchParams.getStudioAudit.examineInfo"></el-input>
										</el-form-item>
									</el-form>
								</el-col>
							</el-row>
							<el-row>
								<el-col :span="3">
									<el-form label-width="100px">
										<el-form-item label="">
											<el-button @click="ascertain(temporaryDate.id)" type="primary" size="medium">确定</el-button>
										</el-form-item>
									</el-form>
								</el-col>
								<el-col :span="3">
        ...
        <div class="dataListArea">
          <el-table class="tableData" :data="tableData" border stripe width="100%">
            ...
            <el-table-column
              ...
              width="300"
            ></el-table-column>
            <el-table-column align="center" width="150" label="审核状态">
              <template slot-scope="scope">
            ...
            <el-table-column align="center" label="操作"  width="200" fixed="right">
              <template slot-scope="scope">
                <el-button
                  type="primary"
                  v-if="scope.row.examineState ==0&&user.roleBtns.indexOf(url+'check')>-1"
                  @click="checkf(scope.row,true)"
                  size="small"
                >审核</el-button>
                <el-button
                  v-if="scope.row.examineState !=0 &&user.roleBtns.indexOf(url+'select')>-1"
                  @click="checkf(scope.row,false)"
                  size="small"
                >查看</el-button>
                <el-button
                  v-if="scope.row.examineState ==0 &&user.roleBtns.indexOf(url+'select')>-1"
